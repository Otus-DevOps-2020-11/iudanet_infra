...
* Создал модули terraform для app и db
...
* Для создания  бакенда terraform с использованием s3 нужно создать 2 ресурса.
  ...
  * S3 бакет в консоли или через awscli
  * Базу для локов в ресурсе Yndex Database. Ресурса для терраформа еще нет, так что нужно создавать базу и таблицу руками в консоли
